				...
				<div className="mx-auto grid w-full grid-cols-[repeat(auto-fill,8rem)] justify-center gap-2 p-2">
					{categories.map((category) => (
						<Link
							...
							key={category}
							className="normal-text hover-effect flex h-28 flex-col items-center justify-center gap-1 rounded-lg bg-light-secondary px-4 py-4 text-xs dark:bg-dark-secondary"
						>
