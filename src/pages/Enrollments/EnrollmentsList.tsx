	...
	return (
		<>
					...
					enrollments.content.length > 0 ? (
						<>
							{enrollments.content.map((enrollment) => {
								...
								return (
									<div
										className={`col-span-full grid grid-cols-subgrid items-center rounded p-1.5 pr-2 ${isPastDeadline ? "bg-red-300 font-medium text-black dark:bg-red-400" : ""}`}
			...
			{enrollments && enrollments.totalPages > 1 && (
				<div className="col-span-full mt-auto flex w-full items-center gap-1 rounded bg-light-secondary px-3 py-2 font-semibold dark:bg-dark-secondary">
					<FaAngleDoubleLeft
